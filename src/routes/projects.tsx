                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-6 max-w-lg leading-relaxed text-muted-foreground">
                        {project.scope}. Designed in 3D, built entirely in-house, and finished with
                        a lighting and planting plan tuned to the way the family uses the property.
                      </p>
                      {images.length > 1 && (
                        <p className="eyebrow mt-10 text-sand">{images.length} photos below</p>
                      )}
                    </div>
                  </div>
