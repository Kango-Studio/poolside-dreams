//#region node_modules/.nitro/vite/services/ssr/assets/site-data-g9ShfZGD.js
var services = [
	{
		slug: "pools-patios",
		title: "Pools & Patios",
...
var projects = [
	...
	},
	{
		...
		place: "New Jersey",
		year: 2024,
		scope: "Rectangular gunite pool & raised spa · Large-format paver terrace · Turf borders & palm landscaping"
	},
	{
		slug: "highwood",
		title: "Highwood",
...
var testimonials = [{
	quote: "They did my previous house backyard 6 years ago and now did my new house. Both times the results and the service were great. I highly recommend them.",
	name: "Guy Avtalion",
...
//#endregion
export { testimonials as i, projects as n, services as r, faqs as t };
