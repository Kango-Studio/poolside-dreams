...
import { t as createCsrfMiddleware } from "./createCsrfMiddleware-DC_heAjD.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-MGbbNklX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Disj4aVW.mjs"),
		import("./start-aFY5YwE9.mjs"),
		import("./empty-plugin-adapters-wYPk3NfP.mjs")
	]);
	return {
		routerEntry,
		startEntry,
